( function(Dataflow) {
  ...
  var $examples = $('<ul class="dataflow-plugin-webaudio-samples"></ul>');

  Dataflow.addPlugin("examples", $examples);
  ...
  var loadExample = function(e) {
    var g = Dataflow.loadGraph( $(e.target).data("dataflow-plugin-webaudio-samples-graph") );
    g.trigger("change");
    return false;
  };
